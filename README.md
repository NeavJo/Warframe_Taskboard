...
### 仓库
- **Prime 部件计数器**：金 / 银 / 铜垃圾三分类，卡片边框带流光动效
- 每张卡片提供 **+1 / -1 / -6 / 编辑** 四个操作按钮
- 数据随 JSON 导出 / 导入 / 云端同步

### 内置浏览器
- 默认打开**灰机 Wiki**，方便查阅中文攻略
- 其他站点（如世界状态、物品掉落、wm市场）以**新标签页**方式跳转，因为它们不支持iframe

### 设置与同步
- **JSON 导出/导入**：含看板任务、提醒、便签、市场收藏、仓库计数的完整数据
...
5. 切换到"便签"页创建待办清单
6. 切换到"市场"页查价
7. 切换到"仓库"页记录 Prime 部件数量
8. 切换到"浏览器"查阅攻略
9. 切换到"设置"配置云端同步或导出/导入数据
